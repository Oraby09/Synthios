import type { PluginRuntime, RuntimeEnv, RuntimeLogger } from "synthios/plugin-sdk/matrix";
...
function createHandlerHarness() {
  ...
  const core = {
    channel: {
      ...
      session: {
        resolveStorePath: vi.fn().mockReturnValue("/tmp/synthios-test-session.json"),

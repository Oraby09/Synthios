...
import { createAccountListHelpers, type SynthiosConfig } from "../runtime-api.js";
...
export function listEnabledMattermostAccounts(cfg: SynthiosConfig): ResolvedMattermostAccount[] {

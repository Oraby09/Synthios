...
import type { SynthiosConfig, loadConfig } from "synthios/plugin-sdk/config-runtime";
import { isDangerousNameMatchingEnabled } from "synthios/plugin-sdk/config-runtime";
import { resolveOpenProviderRuntimeGroupPolicy } from "synthios/plugin-sdk/config-runtime";
import {
...
import { executePluginCommand, matchPluginCommand } from "synthios/plugin-sdk/plugin-runtime";
import {
...
import { dispatchReplyWithDispatcher } from "synthios/plugin-sdk/reply-runtime";
...
type DiscordConfig = NonNullable<SynthiosConfig["channels"]>["discord"];

...
export type DiscordConfig = NonNullable<SynthiosConfig["channels"]>["discord"];
...
export function createDiscordPreflightArgs(params: {
  ...
  return {
    ...
    accountId: "default",
    token: "token",
    runtime: {} as import("synthios/plugin-sdk/runtime-env").RuntimeEnv,
    botUserId: params.botUserId ?? "synthios-bot",

...
import type { SessionBindingRecord } from "synthios/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "synthios/plugin-sdk/reply-runtime";
import type { resolveAgentRoute } from "synthios/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<
  typeof import("synthios/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("synthios/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("synthios/plugin-sdk/config-runtime").SynthiosConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;

...
} from "synthios/plugin-sdk/allowlist-config-edit";
import { createScopedDmSecurityResolver } from "synthios/plugin-sdk/channel-config-helpers";
import { createOpenProviderConfiguredRouteWarningCollector } from "synthios/plugin-sdk/channel-policy";
import {
...
import { buildOutboundBaseSessionKey, normalizeOutboundThreadId } from "synthios/plugin-sdk/core";
import { resolveThreadSessionKeys, type RoutePeer } from "synthios/plugin-sdk/routing";
import {
...
function hasDiscordExecApprovalDmRoute(cfg: SynthiosConfig): boolean {
...
export const discordPlugin: ChannelPlugin<ResolvedDiscordAccount> = {
  ...
  agentPrompt: {
    messageToolHints: () => [
      ...
      "- Forms: add `components.modal` (title, fields). Synthios adds a trigger button and routes submissions as new messages.",
    ],
  },
  messaging: {

...
import { normalizeAccountId } from "synthios/plugin-sdk/account-id";
import { resolveAccountEntry } from "synthios/plugin-sdk/routing";
import type { DiscordAccountConfig, DiscordActionConfig, SynthiosConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: SynthiosConfig): ResolvedDiscordAccount[] {

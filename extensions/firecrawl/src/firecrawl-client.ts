import { markdownToText, truncateText } from "synthios/plugin-sdk/agent-runtime";
import type { SynthiosConfig } from "synthios/plugin-sdk/config-runtime";
import { withTrustedWebToolsEndpoint } from "synthios/plugin-sdk/provider-web-search";
import {
  ...
  resolveCacheTtlMs,
  writeCache,
} from "synthios/plugin-sdk/provider-web-search";
import { wrapExternalContent, wrapWebContent } from "synthios/plugin-sdk/security-runtime";
import {

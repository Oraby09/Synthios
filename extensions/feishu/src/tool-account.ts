...
import type { SynthiosPluginApi } from "../runtime-api.js";
...
function readConfiguredDefaultAccountId(config: SynthiosPluginApi["config"]): string | undefined {
...
export function resolveFeishuToolAccount(params: {
  api: Pick<SynthiosPluginApi, "config">;

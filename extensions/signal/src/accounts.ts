...
import type { SignalAccountConfig } from "synthios/plugin-sdk/signal-core";
...
function mergeSignalAccountConfig(cfg: SynthiosConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: SynthiosConfig): ResolvedSignalAccount[] {

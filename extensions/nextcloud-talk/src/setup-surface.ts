import type { ChannelSetupInput } from "synthios/plugin-sdk/channel-runtime";
import type { SynthiosConfig } from "synthios/plugin-sdk/config-runtime";
import { hasConfiguredSecretInput } from "synthios/plugin-sdk/config-runtime";
import { DEFAULT_ACCOUNT_ID } from "synthios/plugin-sdk/routing";
import { setSetupChannelEnabled } from "synthios/plugin-sdk/setup";
...
export const nextcloudTalkSetupWizard: ChannelSetupWizard = {
  ...
  introNote: {
    ...
    lines: [
      ...
      '2) Run: ./occ talk:bot:install "Synthios" "<shared-secret>" "<webhook-url>" --feature reaction',

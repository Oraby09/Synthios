...
import { fetchGeminiUsage } from "synthios/plugin-sdk/provider-usage";
...
const ENV_VARS = [
  "SYNTHIOS_GEMINI_OAUTH_CLIENT_ID",
  "SYNTHIOS_GEMINI_OAUTH_CLIENT_SECRET",
...
export function registerGoogleGeminiCliProvider(api: SynthiosPluginApi) {

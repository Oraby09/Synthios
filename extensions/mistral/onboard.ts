...
function applyMistralPreset(cfg: SynthiosConfig, primaryModelRef?: string): SynthiosConfig {
...
export function applyMistralProviderConfig(cfg: SynthiosConfig): SynthiosConfig {
  return applyMistralPreset(cfg);
}

export function applyMistralConfig(cfg: SynthiosConfig): SynthiosConfig {

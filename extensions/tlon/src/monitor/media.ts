...
import { fetchWithSsrFGuard } from "synthios/plugin-sdk/infra-runtime";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to Synthios workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".synthios", "workspace", "media", "inbound");
 ...
 * Format matches Synthios's expected attachment structure.
 */

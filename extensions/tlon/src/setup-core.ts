...
export async function resolveTlonSetupConfigured(cfg: SynthiosConfig): Promise<boolean> {
...
export async function resolveTlonSetupStatusLines(cfg: SynthiosConfig): Promise<string[]> {

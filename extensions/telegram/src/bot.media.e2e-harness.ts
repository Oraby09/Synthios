...
import type { GetReplyOptions, MsgContext } from "synthios/plugin-sdk/reply-runtime";
...
type FetchRemoteMediaFn = typeof import("synthios/plugin-sdk/media-runtime").fetchRemoteMedia;
...
export const telegramBotDepsForTest: TelegramBotDeps = {
  loadConfig: (() =>
    ...
    }) as SynthiosConfig) as TelegramBotDeps["loadConfig"],
...
export async function mockMediaRuntimeModuleForTest(
  importOriginal: () => Promise<typeof import("synthios/plugin-sdk/media-runtime")>,
) {
...
vi.mock("synthios/plugin-sdk/media-runtime", mockMediaRuntimeModuleForTest);
...
vi.doMock("synthios/plugin-sdk/agent-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("synthios/plugin-sdk/agent-runtime")>();
  return {
    ...actual,

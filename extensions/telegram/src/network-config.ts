...
import type { TelegramNetworkConfig } from "synthios/plugin-sdk/config-runtime";
import { isTruthyEnvValue } from "synthios/plugin-sdk/infra-runtime";
import { isWSL2Sync } from "synthios/plugin-sdk/infra-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "SYNTHIOS_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "SYNTHIOS_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "SYNTHIOS_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable SYNTHIOS_TELEGRAM_DNS_RESULT_ORDER

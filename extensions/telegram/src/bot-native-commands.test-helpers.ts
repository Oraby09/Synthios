...
import type { TelegramAccountConfig } from "synthios/plugin-sdk/config-runtime";
...
type GetPluginCommandSpecsFn =
  typeof import("synthios/plugin-sdk/plugin-runtime").getPluginCommandSpecs;
type MatchPluginCommandFn = typeof import("synthios/plugin-sdk/plugin-runtime").matchPluginCommand;
type ExecutePluginCommandFn =
  typeof import("synthios/plugin-sdk/plugin-runtime").executePluginCommand;
...
vi.mock("synthios/plugin-sdk/plugin-runtime", () => ({
...
vi.mock("synthios/plugin-sdk/channel-reply-pipeline", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("synthios/plugin-sdk/channel-reply-pipeline")>();
  return {
    ...actual,
...
export function createNativeCommandsHarness(params?: {
  ...
  const telegramDeps = {
    loadConfig: vi.fn(() => params?.cfg ?? ({} as SynthiosConfig)),
  ...
  registerTelegramNativeCommands({
    bot,
    cfg: params?.cfg ?? ({} as SynthiosConfig),

...
import {
  ...
  type SynthiosConfig,
} from "synthios/plugin-sdk/account-resolution";
import { isTruthyEnvValue } from "synthios/plugin-sdk/infra-runtime";
import {
  listBoundAccountIds,
  resolveDefaultAgentBoundAccountId,
} from "synthios/plugin-sdk/routing";
import { formatSetExplicitDefaultInstruction } from "synthios/plugin-sdk/routing";
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.SYNTHIOS_DEBUG_TELEGRAM_ACCOUNTS)) {
...
function listConfiguredAccountIds(cfg: SynthiosConfig): string[] {
...
export function listTelegramAccountIds(cfg: SynthiosConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: SynthiosConfig): string {
...
export function mergeTelegramAccountConfig(
  ...
  // See: https://github.com/synthios/synthios/issues/30673
...
export function listEnabledTelegramAccounts(cfg: SynthiosConfig): ResolvedTelegramAccount[] {

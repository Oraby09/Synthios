...
import { createFinalizableDraftLifecycle } from "synthios/plugin-sdk/channel-runtime";
 ...
 */
const TELEGRAM_DRAFT_STREAM_STATE_KEY = Symbol.for("synthios.telegramDraftStreamState");

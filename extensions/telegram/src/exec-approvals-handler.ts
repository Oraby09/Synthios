...
import { resolveExecApprovalSessionTarget } from "synthios/plugin-sdk/infra-runtime";
import type { ExecApprovalRequest, ExecApprovalResolved } from "synthios/plugin-sdk/infra-runtime";
import { normalizeAccountId, parseAgentSessionKey } from "synthios/plugin-sdk/routing";
...
function isHandlerConfigured(params: { cfg: SynthiosConfig; accountId: string }): boolean {
  const config = resolveTelegramExecApprovalConfig({
    cfg: params.cfg,
    accountId: params.accountId,
  });

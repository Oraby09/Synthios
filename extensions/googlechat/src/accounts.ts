...
import { isSecretRef, type SynthiosConfig } from "synthios/plugin-sdk/core";
...
export function listEnabledGoogleChatAccounts(cfg: SynthiosConfig): ResolvedGoogleChatAccount[] {

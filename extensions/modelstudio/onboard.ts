...
export function applyModelStudioProviderConfig(cfg: SynthiosConfig): SynthiosConfig {
  return applyModelStudioProviderConfigWithBaseUrl(cfg, MODELSTUDIO_GLOBAL_BASE_URL);
}

export function applyModelStudioProviderConfigCn(cfg: SynthiosConfig): SynthiosConfig {
  return applyModelStudioProviderConfigWithBaseUrl(cfg, MODELSTUDIO_CN_BASE_URL);
}

export function applyModelStudioConfig(cfg: SynthiosConfig): SynthiosConfig {
...
export function applyModelStudioConfigCn(cfg: SynthiosConfig): SynthiosConfig {
  return applyModelStudioProviderConfigWithBaseUrl(
    cfg,
    MODELSTUDIO_CN_BASE_URL,
    MODELSTUDIO_DEFAULT_MODEL_REF,

export { HEARTBEAT_PROMPT, stripHeartbeatToken } from "synthios/plugin-sdk/reply-runtime";
export { HEARTBEAT_TOKEN, SILENT_REPLY_TOKEN } from "synthios/plugin-sdk/reply-runtime";

...
export function listWhatsAppAuthDirs(cfg: SynthiosConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: SynthiosConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: SynthiosConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: SynthiosConfig): ResolvedWhatsAppAccount[] {

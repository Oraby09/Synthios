...
function applyKimiCodingPreset(cfg: SynthiosConfig, primaryModelRef?: string): SynthiosConfig {
...
export function applyKimiCodeProviderConfig(cfg: SynthiosConfig): SynthiosConfig {
  return applyKimiCodingPreset(cfg);
}

export function applyKimiCodeConfig(cfg: SynthiosConfig): SynthiosConfig {

 ...
 */
export function applyChutesProviderConfig(cfg: SynthiosConfig): SynthiosConfig {
 ...
 */
export function applyChutesConfig(cfg: SynthiosConfig): SynthiosConfig {
...
export function applyChutesApiKeyConfig(cfg: SynthiosConfig): SynthiosConfig {

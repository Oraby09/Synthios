...
import type { SynthiosPluginConfigSchema } from "../runtime-api.js";
...
function isAcpxPluginRoot(dir: string): boolean {
  return (
    fs.existsSync(path.join(dir, "synthios.plugin.json")) &&
...
export function createAcpxPluginConfigSchema(): SynthiosPluginConfigSchema {
  return {

...
This directory contains the **BlueBubbles external channel plugin** for Synthios.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `synthios/plugin-sdk` helpers.

...
import { resolveChannelMediaMaxBytes, type SynthiosConfig } from "./runtime-api.js";
...
function resolveMediaLocalRoots(params: { cfg: SynthiosConfig; accountId?: string }): string[] {

...
import type { SynthiosPluginConfigSchema } from "synthios/plugin-sdk/core";
...
export function createOpenShellPluginConfigSchema(): SynthiosPluginConfigSchema {

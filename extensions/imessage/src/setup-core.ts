...
export const imessageDmPolicy: ChannelSetupDmPolicy = {
  ...
  getCurrent: (cfg: SynthiosConfig) => cfg.channels?.imessage?.dmPolicy ?? "pairing",
...
function resolveIMessageCliPath(params: { cfg: SynthiosConfig; accountId: string }) {
...
export const imessageCompletionNote = {
  ...
  lines: [
    ...
    "Ensure Synthios has Full Disk Access to Messages DB.",

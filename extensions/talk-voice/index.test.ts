...
import type { SynthiosPluginCommandDefinition } from "../../test/helpers/extensions/plugin-command.js";
...
function createHarness(config: Record<string, unknown>) {
  ...
  const api = {
    runtime,
    registerCommand: vi.fn((definition: SynthiosPluginCommandDefinition) => {
      command = definition;
    }),
  };

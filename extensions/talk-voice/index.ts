import { resolveActiveTalkProviderConfig } from "synthios/plugin-sdk/config-runtime";
import type { SpeechVoiceOption } from "synthios/plugin-sdk/speech";
import { definePluginEntry, type SynthiosPluginApi } from "./api.js";

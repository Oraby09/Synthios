...
import { resolveOutboundMediaUrls } from "synthios/plugin-sdk/reply-payload";
import {
...
const resolveLineDmPolicy = createScopedDmSecurityResolver<ResolvedLineAccount>({
  ...
  approveHint: "synthios pairing approve line <code>",
...
export const linePlugin: ChannelPlugin<ResolvedLineAccount> = {
  ...
  pairing: createTextPairingAdapter({
    idLabel: "lineUserId",
    message: "Synthios: your access has been approved.",

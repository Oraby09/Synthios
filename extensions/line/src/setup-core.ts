import type { ChannelSetupAdapter, SynthiosConfig } from "synthios/plugin-sdk/setup";
import {
  DEFAULT_ACCOUNT_ID,
  listLineAccountIds,
  normalizeAccountId,
...
export function isLineConfigured(cfg: SynthiosConfig, accountId: string): boolean {

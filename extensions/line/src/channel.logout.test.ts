...
import type { SynthiosConfig, PluginRuntime, ResolvedLineAccount } from "../api.js";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: SynthiosConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: SynthiosConfig; accountId: string }): Promise<{

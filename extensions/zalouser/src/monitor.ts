...
import { createDeferred } from "synthios/plugin-sdk/extension-shared";
...
} from "synthios/plugin-sdk/reply-history";
import type {
  MarkdownTableMode,
  SynthiosConfig,
...
function resolveZalouserDmSessionScope(config: SynthiosConfig) {

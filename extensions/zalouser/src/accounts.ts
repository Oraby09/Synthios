...
function mergeZalouserAccountConfig(cfg: SynthiosConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: SynthiosConfig; accountId?: string | null }) {

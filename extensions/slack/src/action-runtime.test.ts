...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): SynthiosConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: SynthiosConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: SynthiosConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();

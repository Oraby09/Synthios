...
type BuildCommandTextFromArgs =
  typeof import("synthios/plugin-sdk/reply-runtime").buildCommandTextFromArgs;
type FindCommandByNativeName =
  typeof import("synthios/plugin-sdk/reply-runtime").findCommandByNativeName;
type ListNativeCommandSpecsForConfig =
  typeof import("synthios/plugin-sdk/reply-runtime").listNativeCommandSpecsForConfig;
type ParseCommandArgs = typeof import("synthios/plugin-sdk/reply-runtime").parseCommandArgs;
type ResolveCommandArgMenu =
  typeof import("synthios/plugin-sdk/reply-runtime").resolveCommandArgMenu;

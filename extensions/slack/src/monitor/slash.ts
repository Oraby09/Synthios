...
import { type ChatCommandDefinition, type CommandArgs } from "synthios/plugin-sdk/reply-runtime";
...
import { chunkItems } from "synthios/plugin-sdk/text-runtime";
...
const SLACK_COMMAND_ARG_ACTION_ID = "synthios_cmdarg";

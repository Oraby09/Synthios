...
} from "synthios/plugin-sdk/account-id";
...
function resolveConfiguredDefaultNostrAccountId(cfg: SynthiosConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: SynthiosConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: SynthiosConfig): string {

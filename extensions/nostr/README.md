...
Nostr DM channel plugin for Synthios using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Synthios. It enables your bot to:
...
# Configure synthios to use local relay

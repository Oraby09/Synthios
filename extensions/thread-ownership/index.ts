import { definePluginEntry, type SynthiosConfig, type SynthiosPluginApi } from "./api.js";
...
function resolveOwnershipAgent(config: SynthiosConfig): { id: string; name: string } {

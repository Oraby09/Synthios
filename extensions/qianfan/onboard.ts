...
function resolveQianfanPreset(cfg: SynthiosConfig): {
  api: ModelApi;
  baseUrl: string;
...
function applyQianfanPreset(cfg: SynthiosConfig, primaryModelRef?: string): SynthiosConfig {
...
export function applyQianfanProviderConfig(cfg: SynthiosConfig): SynthiosConfig {
  return applyQianfanPreset(cfg);
}

export function applyQianfanConfig(cfg: SynthiosConfig): SynthiosConfig {

...
show_usage() {
    cat << EOF
clawlog - Synthios Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Synthios logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Synthios logs flow through the macOS unified log (subsystem: ai.synthios).

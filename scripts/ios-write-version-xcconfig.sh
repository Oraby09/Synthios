...
- SYNTHIOS_GATEWAY_VERSION = exact package.json version
- SYNTHIOS_MARKETING_VERSION = short iOS/App Store version
- SYNTHIOS_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
SYNTHIOS_GATEWAY_VERSION = ${PACKAGE_VERSION}
SYNTHIOS_MARKETING_VERSION = ${MARKETING_VERSION}
SYNTHIOS_BUILD_VERSION = ${BUILD_NUMBER}
EOF

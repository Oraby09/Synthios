...
# Output:
# - dist/Synthios.app
# - dist/Synthios-<version>.zip
# - dist/Synthios-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.synthios.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/Synthios.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Synthios-$VERSION.zip"
DMG="$ROOT_DIR/dist/Synthios-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Synthios-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Synthios-$VERSION.dSYM.zip"

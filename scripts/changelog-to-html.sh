...
if [[ -z "$version_content" ]]; then
  echo "<h2>Synthios $VERSION</h2>"
  echo "<p>Latest Synthios update.</p>"
  echo "<p><a href=\"https://github.com/synthios/synthios/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi

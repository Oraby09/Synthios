---
summary: "Hubs that link to every Synthios doc"
read_when:
...
<Note>
If you are new to Synthios, start with [Getting Started](/start/getting-started).
</Note>
...
- [Synthios assistant](/start/synthios)

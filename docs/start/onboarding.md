---
summary: "First-run setup flow for Synthios (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Synthios">
...
<Step title="CLI">
  ...
  The app can install the global `synthios` CLI via npm/pnpm so terminal

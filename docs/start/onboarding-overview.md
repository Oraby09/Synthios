---
summary: "Overview of Synthios onboarding options and flows"
read_when:
...
Synthios has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `synthios onboard`                     | Launch the app            |
...
CLI command docs: [`synthios onboard`](/cli/onboard)

## macOS app onboarding

Open the Synthios app. The first-run wizard walks you through the same steps

---
summary: "Get Synthios installed and run your first chat in minutes."
read_when:
...
Install Synthios, run onboarding, and chat with your AI assistant — all in
...
<Accordion title="Advanced: environment variables">
  If you run Synthios as a service account or want custom paths:

- `SYNTHIOS_HOME` — home directory for internal path resolution
- `SYNTHIOS_STATE_DIR` — override the state directory
- `SYNTHIOS_CONFIG_PATH` — override the config file path

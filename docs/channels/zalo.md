...
- Install via CLI: `synthios plugins install @synthios/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `synthios plugins install ./extensions/zalo`
   - From npm (if published): `synthios plugins install @synthios/zalo`
...
This page reflects current Synthios behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `synthios pairing list zalo`
  - `synthios pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in Synthios.
...
- Example: `synthios message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `synthios channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `synthios logs --follow`

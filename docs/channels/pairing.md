...
read_when:
  ...
  - Reviewing Synthios security posture
title: "Pairing"
---

# Pairing

“Pairing” is Synthios’s explicit **owner approval** step.
...
Stored under `~/.synthios/credentials/`:
...
3. On your phone, open the Synthios iOS app → Settings → Gateway.
...
- The legacy `node.pair.*` API (CLI: `synthios nodes pending/approve`) is a

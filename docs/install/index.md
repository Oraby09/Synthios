---
summary: "Install Synthios — installer script, npm/pnpm, from source, Docker, and more"
read_when:
...
The fastest way to install. It detects your OS, installs Node if needed, installs Synthios, and launches onboarding.
...
Or skip the link and use `pnpm synthios ...` from inside the repo. See [Setup](/start/setup) for full development workflows.
...
```bash
synthios --version      # confirm the CLI is available
synthios doctor         # check for config issues
synthios gateway status # verify the Gateway is running
```

## Hosting and deployment

Deploy Synthios on a cloud server or VPS:
...
<CardGroup cols={3}>
  ...
  <Card title="Uninstall" href="/install/uninstall" icon="trash-2">
    Remove Synthios completely.
  </Card>
</CardGroup>

## Troubleshooting: `synthios` not found

If the install succeeded but `synthios` is not found in your terminal:

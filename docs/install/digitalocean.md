---
summary: "Host Synthios on a DigitalOcean Droplet"
read_when:
  - Setting up Synthios on DigitalOcean
  - Looking for a simple paid VPS for Synthios
title: "DigitalOcean"
---

# DigitalOcean

Run a persistent Synthios Gateway on a DigitalOcean Droplet.
...
**Gateway will not start** -- Run `synthios doctor --non-interactive` and check logs with `journalctl --user -u synthios-gateway.service -n 50`.

...
read_when:
  - You want to publish a third-party Synthios plugin
...
This page tracks high-quality **community-maintained plugins** for Synthios.

We accept PRs that add community plugins here when they meet the quality bar.

## Required for listing

- Plugin package is published on npmjs (installable via `synthios plugins install <npm-spec>`).
...
- **Plugin Name** — short description
  ...
  install: `synthios plugins install @scope/package`

## Listed plugins

- **WeChat** — Connect Synthios to WeChat personal accounts via WeChatPadPro (iPad protocol). Supports text, image, and file exchange with keyword-triggered conversations.
  npm: `@icesword760/synthios-wechat`
  repo: `https://github.com/icesword0760/synthios-wechat`
  install: `synthios plugins install @icesword760/synthios-wechat`

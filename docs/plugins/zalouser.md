...
read_when:
  - You want Zalo Personal (unofficial) support in Synthios
...
Zalo Personal support for Synthios via a plugin, using native `zca-js` to automate a normal Zalo user account.

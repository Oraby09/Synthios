...
Synthios treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.synthios/settings/voicewake.json`

Shape:

```json
{ "triggers": ["synthios", "claude", "computer"], "updatedAtMs": 1730000000000 }
```

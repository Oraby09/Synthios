...
You can point Synthios at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Synthios
...
- [Anthropic provider](/providers/anthropic) - Native Synthios integration with Claude setup-token or API keys

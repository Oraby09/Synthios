...
Deepgram is a speech-to-text API. In Synthios it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, Synthios uploads the audio file to Deepgram and injects the transcript

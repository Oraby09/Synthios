---
summary: "Use Qwen OAuth (free tier) in Synthios"
read_when:
  - You want to use Qwen with Synthios
...
If you already logged in with the Qwen Code CLI, Synthios will sync credentials

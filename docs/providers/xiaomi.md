---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Synthios"
read_when:
  - You want Xiaomi MiMo models in Synthios
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Synthios uses
...
```bash
synthios onboard --auth-choice xiaomi-api-key
# or non-interactive
synthios onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```

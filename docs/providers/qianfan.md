---
summary: "Use Qianfan's unified API to access many models in Synthios"
read_when:
...
3. Synthios installed on your system
...
4. Copy the API key for use with Synthios

## CLI setup

```bash
synthios onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Synthios Configuration](/gateway/configuration)

---
summary: "Use NVIDIA's OpenAI-compatible API in Synthios"
read_when:
  - You want to use NVIDIA models in Synthios
...
synthios onboard --auth-choice skip
synthios models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```

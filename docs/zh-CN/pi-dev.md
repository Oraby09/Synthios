...
本指南总结了在 Synthios 中开发 Pi 集成的合理工作流程。
...
状态存储在 Synthios 状态目录下。默认为 `~/.synthios`。如果设置了 `SYNTHIOS_STATE_DIR`，则使用该目录。
...
- https://docs.synthios.ai/testing
- https://docs.synthios.ai/start/getting-started

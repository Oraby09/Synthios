...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = SynthiosChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = SynthiosChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)

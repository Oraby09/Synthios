...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.synthios", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.synthios", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: SynthiosProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {

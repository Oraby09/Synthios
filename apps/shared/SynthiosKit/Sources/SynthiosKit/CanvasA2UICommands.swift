...
public enum SynthiosCanvasA2UICommand: String, Codable, Sendable {
...
public struct SynthiosCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct SynthiosCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {

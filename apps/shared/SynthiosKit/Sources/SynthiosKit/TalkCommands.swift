...
public enum SynthiosTalkCommand: String, Codable, Sendable {
...
public struct SynthiosTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct SynthiosTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String

...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: SynthiosProtocol.AnyCodable]?
    {
        ...
        return [
            "id": SynthiosProtocol.AnyCodable(identity.deviceId),
            "publicKey": SynthiosProtocol.AnyCodable(publicKey),
            "signature": SynthiosProtocol.AnyCodable(signature),
            "signedAt": SynthiosProtocol.AnyCodable(signedAtMs),
            "nonce": SynthiosProtocol.AnyCodable(nonce),
        ]
    }
}

...
public typealias SynthiosPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias SynthiosPlatformImage = UIImage
#endif

public struct SynthiosChatUsageCost: Codable, Hashable, Sendable {
...
public struct SynthiosChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: SynthiosChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(SynthiosChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct SynthiosChatMessageContent: Codable, Hashable, Sendable {
...
public struct SynthiosChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [SynthiosChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: SynthiosChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [SynthiosChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: SynthiosChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(SynthiosChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([SynthiosChatMessageContent].self, forKey: .content) {
...
public struct SynthiosChatHistoryPayload: Codable, Sendable {
...
public struct SynthiosSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct SynthiosSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [SynthiosSessionPreviewItem]
}

public struct SynthiosSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [SynthiosSessionPreviewEntry]

    public init(ts: Int, previews: [SynthiosSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct SynthiosChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct SynthiosChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct SynthiosAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct SynthiosChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct SynthiosGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct SynthiosPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: SynthiosPlatformImage?
...
public struct SynthiosChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String

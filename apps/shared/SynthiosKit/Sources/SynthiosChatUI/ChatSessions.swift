...
public struct SynthiosChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct SynthiosChatSessionsDefaults: Codable, Sendable {
...
public struct SynthiosChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct SynthiosChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: SynthiosChatSessionsDefaults?
    public let sessions: [SynthiosChatSessionEntry]
    ...
    public init(
        ...
        sessions: [SynthiosChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count

...
enum SynthiosConfigFile {
    private static let logger = Logger(subsystem: "ai.synthios", category: "config")
    ...
    static func stateDirURL() -> URL {
        SynthiosPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        SynthiosPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-synthios-config-file",
            "event": "config.write",

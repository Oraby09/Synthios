...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/synthios/synthios") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/synthios/synthios")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://synthios.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "SynthiosBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "SynthiosBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "SynthiosGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "SynthiosGitCommit") as? String) ??
            "unknown"
    }

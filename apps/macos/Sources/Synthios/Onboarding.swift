...
enum UIStrings {
    static let welcomeTitle = "Welcome to Synthios"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "synthios.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: SynthiosChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g synthios@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: SynthiosChatViewModel(

...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.synthios", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".synthios/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.synthiosCommand(
            subcommand: "gateway",

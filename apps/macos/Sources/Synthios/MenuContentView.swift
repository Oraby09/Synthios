...
/// Menu contents for the Synthios menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About Synthios") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "Synthios Not Configured"
        case .remote:
            "Remote Synthios Active"
        case .local:
            "Synthios Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .synthiosSelectSettingsTab, object: tab)
        }
    }

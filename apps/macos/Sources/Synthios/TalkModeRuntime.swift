...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.synthios", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.synthios", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [SynthiosChatMessage] = messages.compactMap { item in

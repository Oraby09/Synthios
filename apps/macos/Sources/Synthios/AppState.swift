...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = SynthiosConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = SynthiosConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: SynthiosConfigFile.loadDict(),
        ...
        SynthiosConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/synthios"
        state.remoteCliPath = ""
        return state
    }
}

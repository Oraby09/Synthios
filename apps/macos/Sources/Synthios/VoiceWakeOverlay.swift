...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.synthios", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Synthios windows, but below the system’s pop-up menus.

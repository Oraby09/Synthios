...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.synthios", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return SynthiosConfigFile.defaultWorkspaceURL() }

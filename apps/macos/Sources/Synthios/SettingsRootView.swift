...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .synthiosSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? SynthiosPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? SynthiosPaths.stateDirURL.path
...
extension Notification.Name {
    static let synthiosSelectSettingsTab = Notification.Name("synthiosSelectSettingsTab")
}

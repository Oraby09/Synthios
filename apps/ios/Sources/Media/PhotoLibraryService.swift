...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: SynthiosPhotosLatestParams) async throws -> SynthiosPhotosLatestPayload {
        ...
        var results: [SynthiosPhotoPayload] = []
        ...
        return SynthiosPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> SynthiosPhotoPayload
    {

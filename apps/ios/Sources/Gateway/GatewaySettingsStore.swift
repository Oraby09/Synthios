...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.synthios.gateway"
    private static let nodeService = "ai.synthios.node"
    private static let talkService = "ai.synthios.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.synthios.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.synthios.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("synthios-gateway.log")
    }

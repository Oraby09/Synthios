...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.synthios.ios", category: "LiveActivity")
    private var currentActivity: Activity<SynthiosActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = SynthiosActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<SynthiosActivityAttributes>.activities
    ...
    private func updateCurrent(state: SynthiosActivityAttributes.ContentState) {
    ...
    private func connectingState() -> SynthiosActivityAttributes.ContentState {
        SynthiosActivityAttributes.ContentState(
    ...
    private func idleState() -> SynthiosActivityAttributes.ContentState {
        SynthiosActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> SynthiosActivityAttributes.ContentState {
        SynthiosActivityAttributes.ContentState(

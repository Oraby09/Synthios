...
ASC_KEYCHAIN_SERVICE=synthios-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.synthios.client
# or
...
- The beta flow regenerates `apps/ios/Synthios.xcodeproj` from `apps/ios/project.yml` before archiving

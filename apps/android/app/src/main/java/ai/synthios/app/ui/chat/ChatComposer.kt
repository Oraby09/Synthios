...
import ai.synthios.app.ui.mobileAccentBorderStrong
...
import ai.synthios.app.ui.mobileSurface
import ai.synthios.app.ui.mobileText
import ai.synthios.app.ui.mobileTextSecondary
import ai.synthios.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.synthios.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.synthios.app.ui.mobileFontFamily,

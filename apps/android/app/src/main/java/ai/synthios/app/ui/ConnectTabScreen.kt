    ...
    if (showDiagnostics) {
      Surface(
        ...
        Column(
          ...
          Text("Synthios Android ${openClawAndroidVersionLabel()}", style = mobileCaption1, color = mobileTextSecondary)
          Button(
            onClick = {
    ...
    AnimatedVisibility(visible = advancedOpen) {
      Surface(
        ...
        Column(
          ...
          CommandBlock("synthios qr --setup-code-only")
          CommandBlock("synthios qr --json")

...
export const A2UI_PATH = "/__synthios__/a2ui";

export const CANVAS_HOST_PATH = "/__synthios__/canvas";

export const CANVAS_WS_PATH = "/__synthios__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.synthiosCanvasA2UIAction.postMessage(...)
  // - Android: window.synthiosCanvasA2UIAction.postMessage(...)
  const handlerNames = ["synthiosCanvasA2UIAction"];
  ...
  globalThis.Synthios = globalThis.Synthios ?? {};
  globalThis.Synthios.postMessage = postToNode;
  globalThis.Synthios.sendUserAction = sendUserAction;
  globalThis.synthiosPostMessage = postToNode;
  globalThis.synthiosSendUserAction = sendUserAction;

...
describe("gateway auth", () => {
  ...
  it("resolves token/password from SYNTHIOS gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          SYNTHIOS_GATEWAY_TOKEN: "env-token",
          SYNTHIOS_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides SYNTHIOS_GATEWAY_PASSWORD", () => {

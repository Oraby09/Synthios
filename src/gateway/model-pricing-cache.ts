...
export function collectConfiguredModelPricingRefs(config: SynthiosConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: SynthiosConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();

...
export function hasAmbiguousGatewayAuthModeConfig(cfg: SynthiosConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: SynthiosConfig): void {

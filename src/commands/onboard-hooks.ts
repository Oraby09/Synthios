...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.synthios.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("synthios hooks list")}`,
      `  ${formatCliCommand("synthios hooks enable <name>")}`,
      `  ${formatCliCommand("synthios hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );

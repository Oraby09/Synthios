...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set SYNTHIOS_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `synthios dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control Synthios.");
  } else if (hint) {
    runtime.log(hint);
  }
}

...
function resolveDefaultAccountId(cfg: SynthiosConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: SynthiosConfig): boolean {
...
export function summarizeBindings(cfg: SynthiosConfig, bindings: AgentBinding[]): string[] {

...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: SynthiosConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: SynthiosConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__synthiosMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__synthiosMcporterColdStartWarned;
  });

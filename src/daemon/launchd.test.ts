...
function expectLaunchctlEnableBootstrapOrder(env: Record<string, string | undefined>) {
  ...
  const label = "ai.synthios.gateway";
...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.synthios.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", SYNTHIOS_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.synthios.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when SYNTHIOS_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.synthios.gateway.plist",
    },
    {
      name: "uses profile-specific label when SYNTHIOS_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", SYNTHIOS_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.synthios.jbphoenix.plist",
    },
    {
      name: "prefers SYNTHIOS_LAUNCHD_LABEL over SYNTHIOS_PROFILE",
      env: {
        HOME: "/Users/test",
        SYNTHIOS_PROFILE: "jbphoenix",
        SYNTHIOS_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from SYNTHIOS_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        SYNTHIOS_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty SYNTHIOS_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        SYNTHIOS_PROFILE: "myprofile",
        SYNTHIOS_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.synthios.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {

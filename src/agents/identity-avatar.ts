...
function resolveAvatarSource(cfg: SynthiosConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: SynthiosConfig, agentId: string): AgentAvatarResolution {

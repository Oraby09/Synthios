...
function resolvePostCompactionIndexSyncMode(config?: SynthiosConfig): "off" | "async" | "await" {
...
export async function compactEmbeddedPiSessionDirect(
  ...
  await ensureSynthiosModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createSynthiosCodingTools({
      exec: {

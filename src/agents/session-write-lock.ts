...
const CLEANUP_STATE_KEY = Symbol.for("synthios.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("synthios.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("synthios.sessionWriteLockWatchdogState");

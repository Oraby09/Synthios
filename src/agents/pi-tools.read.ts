...
function resolveAdaptiveReadMaxBytes(options?: SynthiosReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createSynthiosReadTool(base, {
...
export function createSynthiosReadTool(
  base: AnyAgentTool,
  options?: SynthiosReadToolOptions,
): AnyAgentTool {

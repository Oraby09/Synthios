...
async function resolveContext(config: SynthiosConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): SynthiosConfig {
  return {
    agents: {
      defaults: {
        sandbox: {

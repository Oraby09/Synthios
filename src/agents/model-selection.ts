...
export function isCliProvider(provider: string, cfg?: SynthiosConfig): boolean {
...
function resolveAllowedFallbacks(params: { cfg: SynthiosConfig; agentId?: string }): string[] {
  if (params.agentId) {

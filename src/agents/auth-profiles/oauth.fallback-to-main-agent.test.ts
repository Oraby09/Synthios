...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveSynthiosAgentDir() returns mainAgentDir
    process.env.SYNTHIOS_STATE_DIR = tmpDir;
    process.env.SYNTHIOS_AGENT_DIR = mainAgentDir;

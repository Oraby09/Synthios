...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<SynthiosConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<SynthiosConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: SynthiosConfig): WebSearchConfig {

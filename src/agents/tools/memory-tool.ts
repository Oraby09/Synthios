...
function resolveMemoryToolContext(options: { config?: SynthiosConfig; agentSessionKey?: string }) {
...
async function getMemoryManagerContext(params: { cfg: SynthiosConfig; agentId: string }): Promise<
  | {
...
function createMemoryTool(params: {
  ...
  execute: (ctx: { cfg: SynthiosConfig; agentId: string }) => AnyAgentTool["execute"];
}): AnyAgentTool | null {
...
function resolveMemoryCitationsMode(cfg: SynthiosConfig): MemoryCitationsMode {

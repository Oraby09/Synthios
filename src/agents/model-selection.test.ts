...
function resolveAnthropicOpusThinking(cfg: SynthiosConfig) {
...
function createProviderWithModelsConfig(provider: string, models: Array<Record<string, unknown>>) {
  ...
  } as Partial<SynthiosConfig>;
}

function resolveConfiguredRefForTest(cfg: Partial<SynthiosConfig>) {
...
describe("model-selection", () => {
  ...
  describe("buildModelAliasIndex", () => {
    it("should build alias index from config", () => {
      const cfg: Partial<SynthiosConfig> = {
        agents: {
          defaults: {
            models: {

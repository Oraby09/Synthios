...
export const DEFAULT_SANDBOX_IMAGE = "synthios-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "synthios-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "synthios-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "synthios-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "synthios-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "synthios-sandbox-browser";

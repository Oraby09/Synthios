...
function resolveWatchPaths(workspaceDir: string, config?: SynthiosConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: SynthiosConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: SynthiosConfig }) {

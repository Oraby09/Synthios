...
const SYNTHIOS_ATTRIBUTION_PRODUCT = "Synthios";
const SYNTHIOS_ATTRIBUTION_ORIGINATOR = "synthios";

export function resolveProviderAttributionIdentity(
  env: RuntimeVersionEnv = process.env as RuntimeVersionEnv,
): ProviderAttributionIdentity {
  return {
    product: SYNTHIOS_ATTRIBUTION_PRODUCT,
...
function buildOpenAIAttributionPolicy(
  ...
  return {
    ...
    ...identity,
    headers: {
      originator: SYNTHIOS_ATTRIBUTION_ORIGINATOR,
      "User-Agent": `${SYNTHIOS_ATTRIBUTION_ORIGINATOR}/${identity.version}`,
    },
  };
}

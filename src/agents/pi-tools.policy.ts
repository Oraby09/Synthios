...
export function resolveSubagentToolPolicy(cfg?: SynthiosConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: SynthiosConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: SynthiosConfig["tools"];

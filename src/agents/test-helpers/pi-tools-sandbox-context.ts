...
export function createPiToolsSandboxContext(params: PiToolsSandboxContextParams): SandboxContext {
  ...
  return {
    ...
    runtimeId: params.containerName ?? "synthios-sbx-test",
    runtimeLabel: params.containerName ?? "synthios-sbx-test",
    containerName: params.containerName ?? "synthios-sbx-test",

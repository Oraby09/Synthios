...
export function listAuthProfileStorePaths(config: SynthiosConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: SynthiosConfig, stateDir: string): string[] {

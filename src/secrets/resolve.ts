...
function resolveResolutionLimits(config: SynthiosConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: SynthiosConfig): SecretProviderConfig {

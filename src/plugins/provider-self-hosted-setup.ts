...
export function applyProviderDefaultModel(cfg: SynthiosConfig, modelRef: string): SynthiosConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  maxTokens?: number;
}): { config: SynthiosConfig; modelId: string; modelRef: string; profileId: string } {

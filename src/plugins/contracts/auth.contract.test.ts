...
import type { SynthiosPluginApi, ProviderPlugin } from "../types.js";

type LoginOpenAICodexOAuth =
  (typeof import("synthios/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
...
type GithubCopilotLoginCommand =
  (typeof import("synthios/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
type CreateVpsAwareHandlers =
  (typeof import("../provider-oauth-flow.js"))["createVpsAwareOAuthHandlers"];
type EnsureAuthProfileStore =
  typeof import("synthios/plugin-sdk/agent-runtime").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("synthios/plugin-sdk/agent-runtime").listProfilesForProvider;
...
vi.mock("synthios/plugin-sdk/provider-auth-login", async (importOriginal) => {
  const actual = await importOriginal<typeof import("synthios/plugin-sdk/provider-auth-login")>();
  return {
    ...actual,
...
vi.mock("synthios/plugin-sdk/agent-runtime", async (importOriginal) => {
...
function registerProviders(...plugins: Array<{ register(api: SynthiosPluginApi): void }>) {

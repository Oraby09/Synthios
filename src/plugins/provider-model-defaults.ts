...
export function applyGoogleGeminiModelDefault(cfg: SynthiosConfig): {
  next: SynthiosConfig;
  changed: boolean;
} {
...
export function applyOpenAIProviderConfig(cfg: SynthiosConfig): SynthiosConfig {
...
export function applyOpenAIConfig(cfg: SynthiosConfig): SynthiosConfig {
...
export function applyOpencodeGoModelDefault(cfg: SynthiosConfig): {
  next: SynthiosConfig;
  changed: boolean;
} {
...
export function applyOpencodeZenModelDefault(cfg: SynthiosConfig): {
  next: SynthiosConfig;
  changed: boolean;
} {

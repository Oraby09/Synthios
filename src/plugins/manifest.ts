...
export const PLUGIN_MANIFEST_FILENAME = "synthios.plugin.json";
...
// package.json "synthios" metadata (used for setup/catalog)
...
export type SynthiosPackageStartup = {
  /**
...
export type SynthiosPackageManifest = {
  extensions?: string[];
  setupEntry?: string;
  channel?: PluginPackageChannel;
  install?: PluginPackageInstall;
  startup?: SynthiosPackageStartup;
};
...
): SynthiosPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }

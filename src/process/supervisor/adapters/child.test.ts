...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.SYNTHIOS_SERVICE_MARKER;
  ...
  beforeEach(async () => {
    ...
    delete process.env.SYNTHIOS_SERVICE_MARKER;
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.SYNTHIOS_SERVICE_MARKER = originalServiceMarker;
    }
  });

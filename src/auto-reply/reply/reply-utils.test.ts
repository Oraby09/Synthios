...
describe("matchesMentionWithExplicit", () => {
  const mentionRegexes = [/\bsynthios\b/i];
  ...
  it("resolves known variables, aliases, and case-insensitive tokens", () => {
    const cases = [
      ...
      },
      {
        ...
        values: {
          identityName: "Synthios",
          provider: "anthropic",
          model: "claude-opus-4-5",
          thinkingLevel: "high",
        },
        expected: "[Synthios] anthropic/claude-opus-4-5 (think:high)",
      },
    ] as const;

...
function resolveAcpStreamCoalesceIdleMs(cfg: SynthiosConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: SynthiosConfig): number {
...
export function resolveAcpProjectionSettings(cfg: SynthiosConfig): AcpProjectionSettings {

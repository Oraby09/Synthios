...
function createMatrixThreadCommandParams(commandBody: string, cfg: SynthiosConfig = baseCfg) {
...
function createMatrixRoomCommandParams(commandBody: string, cfg: SynthiosConfig = baseCfg) {
  const params = buildCommandTestParams(commandBody, cfg, {
    Provider: "matrix",
    Surface: "matrix",
    OriginatingChannel: "matrix",

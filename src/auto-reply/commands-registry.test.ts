...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@synthios", { botUsername: "synthios" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@synthios args", {
        botUsername: "synthios",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@synthios: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "synthios" })).toBe(
      "/help@otherbot",
    );
  });

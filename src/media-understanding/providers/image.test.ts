...
const ensureSynthiosModelsJsonMock = vi.fn(async () => {});
...
describe("describeImageWithModel", () => {
  beforeEach(async () => {
    ...
    vi.doMock("../../agents/models-config.js", () => ({
      ensureSynthiosModelsJson: ensureSynthiosModelsJsonMock,
    }));
  ...
  it("routes minimax-portal image models through the MiniMax VLM endpoint", async () => {
    ...
    expect(ensureSynthiosModelsJsonMock).toHaveBeenCalled();

/**
 * Hook system for Synthios agent events
 *
...
const _g = globalThis as typeof globalThis & {
  __synthios_internal_hook_handlers__?: Map<string, InternalHookHandler[]>;
};
const handlers = (_g.__synthios_internal_hook_handlers__ ??= new Map<
  string,
  InternalHookHandler[]
>());

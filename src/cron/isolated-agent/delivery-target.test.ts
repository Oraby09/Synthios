...
function makeCfg(overrides?: Partial<SynthiosConfig>): SynthiosConfig {
  return {
    bindings: [],
    channels: {},
    ...overrides,
...
function makeTelegramBoundCfg(accountId = "account-b"): SynthiosConfig {
  return makeCfg({
    bindings: [
      {
        agentId: AGENT_ID,
...
async function resolveLastTarget(cfg: SynthiosConfig) {

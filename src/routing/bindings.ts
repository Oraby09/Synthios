...
export function listBindings(cfg: SynthiosConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: SynthiosConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: SynthiosConfig) {

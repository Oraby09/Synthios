...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("synthios.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("synthios.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: SynthiosConfig): Promise<ContextEngine> {

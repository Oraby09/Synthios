...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof SynthiosConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: SynthiosConfig; env: NodeJS.ProcessEnv }): {
  cfg: SynthiosConfig;
  changes: string[];
  policyFlips: Set<string>;
} {

    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["synthios channels list", "List configured channels and auth profiles."],
          ["synthios channels status --probe", "Run channel status checks and probes."],
          [
            "synthios channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["synthios channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.synthios.ai/cli/channels",
        )}\n`,
    );

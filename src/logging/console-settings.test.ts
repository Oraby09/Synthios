...
let originalSynthiosTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalSynthiosTestConsole = process.env.SYNTHIOS_TEST_CONSOLE;
  process.env.SYNTHIOS_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalSynthiosTestConsole === undefined) {
    delete process.env.SYNTHIOS_TEST_CONSOLE;
  } else {
    process.env.SYNTHIOS_TEST_CONSOLE = originalSynthiosTestConsole;
  }

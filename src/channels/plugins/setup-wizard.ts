...
export type ChannelSetupWizardStatus = {
  ...
  resolveConfigured: (params: { cfg: SynthiosConfig }) => boolean | Promise<boolean>;
...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: SynthiosConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: SynthiosConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: SynthiosConfig; accountId: string }) => boolean;
  inspect: (params: {
    cfg: SynthiosConfig;
    accountId: string;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: SynthiosConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: SynthiosConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: SynthiosConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: SynthiosConfig;
    accountId: string;
...
export type ChannelSetupWizard = {
  ...
  disable?: (cfg: SynthiosConfig) => SynthiosConfig;

...
export function listChannelMessageActions(cfg: SynthiosConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: SynthiosConfig): ChannelMessageCapability[] {

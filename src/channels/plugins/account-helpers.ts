...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: SynthiosConfig): string | undefined {
  ...
  function listAccountIds(cfg: SynthiosConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: SynthiosConfig): string {

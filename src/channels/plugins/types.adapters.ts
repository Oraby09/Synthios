...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: SynthiosConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: SynthiosConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: SynthiosConfig) => string;
  setAccountEnabled?: (params: {
    cfg: SynthiosConfig;
    accountId: string;
    enabled: boolean;
  }) => SynthiosConfig;
  deleteAccount?: (params: { cfg: SynthiosConfig; accountId: string }) => SynthiosConfig;
  isEnabled?: (account: ResolvedAccount, cfg: SynthiosConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: SynthiosConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: SynthiosConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: SynthiosConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: SynthiosConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.synthios.ai/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: SynthiosConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
...
export type ChannelLifecycleAdapter = {
  onAccountConfigChanged?: (params: {
    prevCfg: SynthiosConfig;
    nextCfg: SynthiosConfig;
    accountId: string;
    runtime: RuntimeEnv;
  }) => Promise<void> | void;
...
export type ChannelExecApprovalAdapter = {
  ...
  hasConfiguredDmRoute?: (params: { cfg: SynthiosConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: SynthiosConfig; accountId?: string | null }) =>
    | {

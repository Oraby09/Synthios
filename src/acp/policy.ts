...
export function isAcpEnabledByPolicy(cfg: SynthiosConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: SynthiosConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: SynthiosConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: SynthiosConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: SynthiosConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: SynthiosConfig, agentId: string): boolean {

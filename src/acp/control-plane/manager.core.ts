...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: SynthiosConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: SynthiosConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: SynthiosConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: SynthiosConfig }): Promise<void> {

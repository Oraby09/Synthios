...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when SYNTHIOS_VERSION is not set", async () => {
  ...
  it("prefers SYNTHIOS_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over SYNTHIOS_SERVICE_VERSION when SYNTHIOS_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        SYNTHIOS_VERSION: " ",
        SYNTHIOS_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when SYNTHIOS_VERSION and SYNTHIOS_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        SYNTHIOS_VERSION: " ",
        SYNTHIOS_SERVICE_VERSION: "\t",

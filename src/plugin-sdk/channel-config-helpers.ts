...
export function createScopedAccountConfigAccessors<
  ResolvedAccount,
  Config extends SynthiosConfig = SynthiosConfig,
>(params: {
...
> {
  const base = {
    resolveAllowFrom: ({ cfg, accountId }: { cfg: SynthiosConfig; accountId?: string | null }) =>
      mapAllowFromEntries(
...
function setTopLevelChannelEnabledInConfigSection<Config extends SynthiosConfig>(params: {
  cfg: Config;
  sectionKey: string;
  enabled: boolean;
}): Config {
...
function removeTopLevelChannelConfigSection<Config extends SynthiosConfig>(params: {
  cfg: Config;
  sectionKey: string;
}): Config {
...
function clearTopLevelChannelConfigFields<Config extends SynthiosConfig>(params: {
  cfg: Config;
  sectionKey: string;
  clearBaseFields: string[];
}): Config {

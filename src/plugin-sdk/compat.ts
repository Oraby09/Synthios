...
const shouldWarnCompatImport =
  ...
  process.env.SYNTHIOS_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "synthios/plugin-sdk/compat is deprecated for new plugins. Migrate to focused synthios/plugin-sdk/<subpath> imports.",
    {
      code: "SYNTHIOS_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:

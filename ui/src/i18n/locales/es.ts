...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.synthios/synthios.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde synthios dashboard --no-open en tu escritorio.",
    },
    insecure: {

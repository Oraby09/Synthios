...
import { SynthiosApp } from "./app.ts";
import {
...
function resetChatStateForSessionSwitch(state: AppViewState, sessionKey: string) {
  ...
  (state as unknown as SynthiosApp).chatStreamStartedAt = null;
  state.chatRunId = null;
  (state as unknown as SynthiosApp).resetToolStream();
  (state as unknown as SynthiosApp).resetChatScroll();
  state.applySettings({
    ...state.settings,
    sessionKey,
  ...
  return html`
    <div class="chat-controls">
      <button
        ...
        @click=${async () => {
          const app = state as unknown as SynthiosApp;

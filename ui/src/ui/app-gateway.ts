...
export function connectGateway(host: GatewayHost) {
  ...
  const client = new GatewayBrowserClient({
    ...
    clientName: "synthios-control-ui",
    clientVersion,
    mode: "webchat",
    ...
    onHello: (hello) => {
      ...
      void subscribeSessions(host as unknown as SynthiosApp);
      void loadAssistantIdentity(host as unknown as SynthiosApp);
      void loadAgents(host as unknown as SynthiosApp);
      void loadHealthState(host as unknown as SynthiosApp);
      void loadNodes(host as unknown as SynthiosApp, { quiet: true });
      void loadDevices(host as unknown as SynthiosApp, { quiet: true });
...
function handleTerminalChatEvent(
  ...
  if (runId && host.refreshSessionsAfterChat.has(runId)) {
    ...
    if (state === "final") {
      void loadSessions(host as unknown as SynthiosApp, {
  ...
  if (hadToolEvents && state === "final") {
    void loadChatHistory(host as unknown as SynthiosApp);
    return true;
  }
  return false;
}
...
function handleChatGatewayEvent(host: GatewayHost, payload: ChatEventPayload | undefined) {
  ...
  const state = handleChatEvent(host as unknown as SynthiosApp, payload);

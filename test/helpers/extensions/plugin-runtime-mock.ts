import { DEFAULT_MODEL, DEFAULT_PROVIDER } from "synthios/plugin-sdk/agent-runtime";
import type { PluginRuntime } from "synthios/plugin-sdk/testing";
import { removeAckReactionAfterReply, shouldAckReaction } from "synthios/plugin-sdk/testing";
...
export function createPluginRuntimeMock(overrides: DeepPartial<PluginRuntime> = {}): PluginRuntime {
  const base: PluginRuntime = {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/synthios"),
    },
    modelAuth: {
